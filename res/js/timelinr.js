...
jQuery.fn.timelinr = function(options){
	...
	settings = jQuery.extend({
		...
		datesSpeed: 				500,				// value: integer between 100 and 1000 (recommended), default to 500 (normal)日期的速度
	...
	$(function(){
		...
		if(settings.orientation == 'horizontal') {	
			...
			$(settings.datesDiv).height((heightDate + 15)*howManyDates).css('marginTop',30);
